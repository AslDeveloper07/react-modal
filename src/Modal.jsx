...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div onClick={onClose} className="fixed h-full w-full bg-[#0000003c] backdrop-blur-3xl flex items-center justify-center z-44 px-4">
      <div className="  bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden relative animate-fade-in-up">
        ...
        <div className=" p-4 ">
          ...
          <button
            onClick={onClose}
            className="bg-orange-600 cursor-pointer text-white text-xl w-full hover:bg-orange-700 transition duration-200 mt-10 py-2 px-4 rounded-md"
          >
            Yopish
          </button>
        </div>
